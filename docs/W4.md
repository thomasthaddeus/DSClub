...
1. Invite a guest speaker from industry or academia.
1. The lecture could be on a range of topics like emerging trends in data science, real-world applications, career advice, etc.
1. Include a Q&A session for club members to interact with the guest.
